...
export function LoginPage() {
  ...
  const handleEmailLogin = async (e: React.FormEvent) => {
    ...
    console.log('Login with email:', loginData);
  };
            ...
            {isSignupMode && (
              ...
              >
                <p className="text-blue-200 text-sm text-center leading-relaxed">
                  🚀 <strong>Novidade!</strong> O cadastro direto ainda não está disponível.
                  <br />
                  Por enquanto, use o <strong>Google</strong> para criar sua conta automaticamente.
                </p>
              </motion.div>
            )}
